<div class="desca">
<h1 class="como"><?php _e('As recruiter', APP_TD); ?>:</h1>
<ul>
	
		
	<?php if (get_option('enable_login_tab3') != 'Yes') { ?>
	
	
	<li><?php _e('Post a job in minutes', APP_TD); ?>.</li>
	...
	<li><?php _e('Browse candidates&#039 database.', APP_TD); ?>.</li>
	<li><?php _e('Reach thousands of job seekers on social media', APP_TD); ?>.</li>
...
<?php
		...
		<?php echo stripslashes(get_option('content_login_tab3')); ?>
