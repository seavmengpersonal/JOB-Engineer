...
<div id="browseby" class="tabbed_section"><div class="contents">
    <ul>
		...
		if ($terms) :
			echo '<li><a class="top" href="#open">'.__('Job Location', APP_TD).'</a> <ul>';
		
			foreach($terms as $term) :
				echo '<li class="page_item ';
				if ( isset($wp_query->queried_object->slug) && $wp_query->queried_object->slug==$term->slug ) echo 'current_page_item';
				echo '"><a href="'.get_term_link( $term->slug, 'job_loc' ).'">'.$term->name.' ['. $term->count .']</a></li>';
			endforeach;
		...
		if ($terms) :
			...
			foreach($terms as $term) :
				echo '<li class="page_item ';
				if ( isset($wp_query->queried_object->slug) && $wp_query->queried_object->slug==$term->slug ) echo 'current_page_item';
				echo '"><a href="'.get_term_link( $term->slug, 'job_type' ).'">'.$term->name.' ['. $term->count .']</a></li>';
			endforeach;
		...
		if ($terms) :
			...
			foreach($terms as $term) :
				echo '<li class="page_item ';
				if ( isset($wp_query->queried_object->slug) && $wp_query->queried_object->slug==$term->slug ) echo 'current_page_item';
				echo '"><a href="'.get_term_link( $term->slug, 'job_salary' ).'">'.$term->name.' ['. $term->count .']</a></li>';
			endforeach;
		...
		if ($terms) :
                    ...
                    foreach($terms as $term):
                    	echo '<li class="page_item ';
                    	if ( isset($wp_query->queried_object->slug) && $wp_query->queried_object->slug==$term->slug ) echo 'current_page_item';
                    	echo '"><a href="'.get_term_link( $term->slug, 'job_cat' ).'">'.$term->name.' ['. $term->count .']</a></li>';
