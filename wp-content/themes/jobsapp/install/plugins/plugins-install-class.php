...
class pluginsInstallClass {
    ...
    static function moveToThemeOptions(){
        ...
        //wp_enqueue_script(
            //  'ff_autoinstall4',
             // get_stylesheet_directory_uri().'/install/plugins/js-plugins-install-4.js',
              //rray('jquery'),
             // md5( filemtime( get_stylesheet_directory().'/install/plugins/js-plugins-install-4.js' ) ),
              //false  // into footer
       // );
    }
    ...
    static function addAfterAutoInstall(){
        ...
        //wp_enqueue_script(
             // 'ff_autoinstall3',
             // get_stylesheet_directory_uri().'/install/plugins/js-plugins-install-3.js',
              //array('jquery'),
             // md5( filemtime( get_stylesheet_directory().'/install/plugins/js-plugins-install-3.js' ) ),
              //false  // into footer
        //);
    }
    ...
    static function addAutoInstallJavaScript(){
       ...
       // wp_enqueue_script(
             // 'ff_autoinstall2',
             // get_stylesheet_directory_uri().'/install/plugins/js-plugins-install-2.js',
              //array('jquery'),
            //  md5( filemtime( get_stylesheet_directory().'/install/plugins/js-plugins-install-2.js' ) ),
              //false  // into footer
      //  );
    }
    ...
    static function redirectToInstallPlugins(){
       ...
       // wp_enqueue_script(
              //'ff_autoinstall1',
             // get_stylesheet_directory_uri().'/install/plugins/js-plugins-install-1.js',
              //array('jquery'),
