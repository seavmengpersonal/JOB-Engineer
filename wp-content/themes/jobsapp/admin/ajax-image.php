...
if (!function_exists('jobthemes_ajax_image_upload') || !function_exists('jobthemes_ajax_image_remove')) {
//Save image via AJAX
    add_action('wp_ajax_jobthemes_ajax_upload', 'jobthemes_ajax_image_upload'); //Add support for AJAX save

    function jobthemes_ajax_image_upload() {
...
//Remove image via AJAX
    add_action('wp_ajax_jobthemes_ajax_remove', 'jobthemes_ajax_image_remove'); //Add support for AJAX save

    function jobthemes_ajax_image_remove() {
        global $wpdb; //Now WP database can be accessed
