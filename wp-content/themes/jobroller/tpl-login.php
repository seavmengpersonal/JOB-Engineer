...
?>
	...
	<div class="section">
    	...
    	<div class="section_content">
			...
			<p><?php _e('You must login or create an account in order to post a job or submit your CV.', APP_TD); ?></p>

				<ul>
					<li><?php echo sprintf( __( 'As a <strong>%s</strong> you\'ll be able to submit your profile, post your CV, and be found by employers.', APP_TD ), __( 'Job Seeker', APP_TD ) ); ?></li>
