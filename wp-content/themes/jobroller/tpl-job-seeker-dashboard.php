	...
	<div class="section">
		...
		<div class="section_content">
			...
			<div id="dashboard" class="myprofile_section">
				...
				<h3><?php _e('Applied & Starred Jobs', APP_TD); ?></h3>
				<?php
			...
			<div id="resumes" class="myprofile_section">
				...
				<p><?php _e('Your CV are displayed below. From this page you can create a new CV, edit a CV, and set whether or not it is visible on the site or private.', APP_TD); ?></p>
				...
				<form class="submit_form main_form" method="post" action="<?php echo get_permalink( JR_Resume_Edit_Page::get_id() ); ?>">
					<p><input type="submit" class="submit" value="<?php _e('Add CV&raquo;', APP_TD)?>" /></p>
				</form>
