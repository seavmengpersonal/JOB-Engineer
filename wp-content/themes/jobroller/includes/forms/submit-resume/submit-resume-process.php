...
update_post_meta($resume_id, 'r_qualification2', $_POST['r_qualification2']);
update_post_meta($resume_id, 's_day2', $_POST['s_day2']);
update_post_meta($resume_id, 's_month2', $_POST['s_month2']);
update_post_meta($resume_id, 's_year2', $_POST['s_year2']);
update_post_meta($resume_id, 'e_day2', $_POST['e_day2']);
update_post_meta($resume_id, 'e_month2', $_POST['e_month2']);
update_post_meta($resume_id, 'e_year2', $_POST['e_year2']);
update_post_meta($resume_id, 'r_university2', $_POST['r_university2']);
update_post_meta($resume_id, 'r_field2', $_POST['r_field2']);
update_post_meta($resume_id, 'r_e_description2', $_POST['r_e_description2']);

update_post_meta($resume_id, 'r_qualification3', $_POST['r_qualification3']);
update_post_meta($resume_id, 's_day3', $_POST['s_day3']);
update_post_meta($resume_id, 's_month3', $_POST['s_month3']);
update_post_meta($resume_id, 's_year3', $_POST['s_year3']);
update_post_meta($resume_id, 'e_day3', $_POST['e_day3']);
update_post_meta($resume_id, 'e_month3', $_POST['e_month3']);
update_post_meta($resume_id, 'e_year3', $_POST['e_year3']);
update_post_meta($resume_id, 'r_university3', $_POST['r_university3']);
update_post_meta($resume_id, 'r_field3', $_POST['r_field3']);
update_post_meta($resume_id, 'r_e_description3', $_POST['r_e_description3']);

update_post_meta($resume_id, 'r_qualification4', $_POST['r_qualification4']);
update_post_meta($resume_id, 's_day4', $_POST['s_day4']);
update_post_meta($resume_id, 's_month4', $_POST['s_month4']);
update_post_meta($resume_id, 's_year4', $_POST['s_year4']);
update_post_meta($resume_id, 'e_day4', $_POST['e_day4']);
update_post_meta($resume_id, 'e_month4', $_POST['e_month4']);
update_post_meta($resume_id, 'e_year4', $_POST['e_year4']);
update_post_meta($resume_id, 'r_university4', $_POST['r_university4']);
update_post_meta($resume_id, 'r_field4', $_POST['r_field4']);
update_post_meta($resume_id, 'r_e_description4', $_POST['r_e_description4']);
...
update_post_meta($resume_id, 'r_h_language2', $_POST['r_h_language2']);
update_post_meta($resume_id, 'l_r_level2', $_POST['l_r_level2']);

update_post_meta($resume_id, 'r_h_language3', $_POST['r_h_language3']);
update_post_meta($resume_id, 'l_r_level3', $_POST['l_r_level3']);

update_post_meta($resume_id, 'r_h_language4', $_POST['r_h_language4']);
update_post_meta($resume_id, 'l_r_level4', $_POST['l_r_level4']);
...
update_post_meta($resume_id, 'r_company_name2', $_POST['r_company_name2']);
update_post_meta($resume_id, 'w_s_day2', $_POST['w_s_day2']);
update_post_meta($resume_id, 'w_s_month2', $_POST['w_s_month2']);
update_post_meta($resume_id, 'w_s_year2', $_POST['w_s_year2']);
update_post_meta($resume_id, 'w_e_day2', $_POST['w_e_day2']);
update_post_meta($resume_id, 'w_e_month2', $_POST['w_e_month2']);
update_post_meta($resume_id, 'w_e_year2', $_POST['w_e_year2']);
update_post_meta($resume_id, 'w_r_position2', $_POST['w_r_position2']);
update_post_meta($resume_id, 'w_e_description2', $_POST['w_e_description2']);

update_post_meta($resume_id, 'r_company_name3', $_POST['r_company_name3']);
update_post_meta($resume_id, 'w_s_day3', $_POST['w_s_day3']);
update_post_meta($resume_id, 'w_s_month3', $_POST['w_s_month3']);
update_post_meta($resume_id, 'w_s_year3', $_POST['w_s_year3']);
update_post_meta($resume_id, 'w_e_day3', $_POST['w_e_day3']);
update_post_meta($resume_id, 'w_e_month3', $_POST['w_e_month3']);
update_post_meta($resume_id, 'w_e_year3', $_POST['w_e_year3']);
update_post_meta($resume_id, 'w_r_position3', $_POST['w_r_position3']);
update_post_meta($resume_id, 'w_e_description3', $_POST['w_e_description3']);

update_post_meta($resume_id, 'r_company_name4', $_POST['r_company_name4']);
update_post_meta($resume_id, 'w_s_day4', $_POST['w_s_day4']);
update_post_meta($resume_id, 'w_s_month4', $_POST['w_s_month4']);
update_post_meta($resume_id, 'w_s_year4', $_POST['w_s_year4']);
update_post_meta($resume_id, 'w_e_day4', $_POST['w_e_day4']);
update_post_meta($resume_id, 'w_e_month4', $_POST['w_e_month4']);
update_post_meta($resume_id, 'w_e_year4', $_POST['w_e_year4']);
update_post_meta($resume_id, 'w_r_position4', $_POST['w_r_position4']);
update_post_meta($resume_id, 'w_e_description4', $_POST['w_e_description4']);
