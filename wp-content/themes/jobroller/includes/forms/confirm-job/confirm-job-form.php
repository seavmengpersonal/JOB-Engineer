...
<form method="POST" class="submit_form main_form" action="<?php echo esc_url( $form_action ) ?>">
	...
	<p>
		<input type="submit" name="goback" class="goback  btn btn-danger" value="<?php _e( 'Go Back', APP_TD ) ?>"  />
		<input type="submit" class="submit btn btn-primary" name="job_confirm" value="<?php esc_attr_e( 'Confirm / Continue to Job', APP_TD ); ?>">
