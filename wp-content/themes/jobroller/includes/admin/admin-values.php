...
$options_settings = array(
	...
	array(
		...
		'desc' 		=> '',
		'tip' 		=> __('Allows Job Seekers to signup. Job Seekers cannot post jobs; they can only find jobs and submit their CV.',APP_TD),
	...
	array(
		...
		'desc' 		=> '',
		'tip' 		=> __('Allows recruiters to signup. Recruiters can post posts and, if you don\'t have CV subscriptions enabled, can also view CV, unlike job listers who can only post jobs.
						If your site requires a subscription to view/browse CV, access will always depend on your visibility settings.',APP_TD),
	...
	array(
		...
		'min' 		=> '',
		'type' 		=> 'textarea',
		'std' 		=> 'Submit your CV, update your profile, and allow employers to find <em>you</em>!'
	),

	array(
		'name' => __('"Submit your CV" Button Text',APP_TD),
		'desc' 		=> '',
		'tip' 		=> __('This text will appear below the Submit your CV button when browsing CV.',APP_TD),
		...
		'min' 		=> '',
		'type' 		=> 'textarea',
		'std' 		=> 'Register as a Job Seeker to submit your CV.'
	),

	array( 'name' => __('CV Options', APP_TD), 'type' => 'title', 'desc' 		=> __('Control who can view CV', APP_TD) ),

	array(
		'name' => __('CV Listings Visibility',APP_TD),
		'desc' 		=> '',
		'tip' 		=> __('Lets you define who can browse through submitted CV.',APP_TD),
	...
	array(
		'name' => __('CV Visibility',APP_TD),
		'desc' 		=> '',
		'tip' 		=> __('Lets you define who can view submitted CV.',APP_TD),
	...
	array(
		'name' => __('CV per Page',APP_TD),
		'desc'		=> '',
		'tip'		=> __( 'How many CV per page do you want shown?.',APP_TD),
	...
	array(	'name' => __('Subscription Options', APP_TD), 'type' 		=> 'title','desc' 		=> __('Control subscriptions for CV access', APP_TD), 'id' 		=> '' ),

	array(
		'name' => __('Require active subscription to view CV?',APP_TD),
		'desc' 		=>  sprintf( __( 'Enabling this option will block access to the CV section if the user does not have a subscription.
						   ...
						   <br/><br/>
						   <strong>Note:</strong> If you set the visibility settings to \'Public\' this option will be ignored, and any user role, including visitors, will be able to Browse and/or View CV without a subscription.
						   <br/><br/>
						   You can create CV Plans that Employers/Recruiters or even Job Seekers can subscribe to, on the <a href="%s">CV Plans Page</a> in the Payments Menu.', APP_TD ),
	...
	array(
		...
		'min' 		=> '',
		'type' 		=> 'textarea',
		'std' 		=> 'Sorry, you do not have access to CV. To access and/or view our CV database please subscribe.'
	),

	array( 'name' => __('Anti-Spam', APP_TD), 'type' => 'title', 'desc' 		=> __('Secure CV contact details', APP_TD) ),

	array(
		'name' => __('Enable Contact Form',APP_TD),
		'desc' 		=> __( 'Choose whether you want show a contact form instead of the CV author contact details (email, mobile and telephone).', APP_TD ),
		'tip' 		=> __( 'To avoid spammers you can hide the CV contact details and let employers contact CV authors using a popup contact form.', APP_TD ),
	...
	array(
		...
		'tip' 		=> __('Set this option to yes to enable the reCaptcha service that will protect your site against spam contacts. It will show a verification box on your contact form page and on the online CV contact form. It requires a human to read and enter the words.',APP_TD),
...
$options_pricing = array (
	...
	array(  'type' 		=> 'tab', 'tabname' => __('Browse CV Pricing', APP_TD)),
	...
	array(
		'name' => __('CV Access Subscription Price', APP_TD),
		'desc' 		=> __('Only enter numeric values or decimal points. Do not include a currency symbol or commas.', APP_TD),
		'tip' 		=> __('This is the amount you want to charge job listers access to the CV database.',APP_TD),
	...
	array(
		'name' => __('CV Access Trial Price', APP_TD),
		'desc' 		=> __('Only enter numeric values or decimal points. Do not include a currency symbol or commas.', APP_TD),
		'tip' 		=> __('This is the amount you want to charge job listers access to the CV database for their first billing term. Leave blank for free trial.',APP_TD),
